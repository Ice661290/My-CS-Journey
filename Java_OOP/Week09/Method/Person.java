class Person{  //class
    ...
    protected Faculty FAC;  //Call it for the infor this class
    ...
    // Setter() - set value and keep in attribute
    // Getter() - return or ดึงค่า or แสดง ค่าattributeที่เก็บไว้
    // Work method - ทำงานอะไรก็ได้ไม่จำเป็นต้องตั้งชื่อเป็น work set get
